...
class Case:
    ...
    def home(self):
        ...
        self.button5 = Button(gui, text=' Another type ', fg='black',
                         command=lambda: self.NewFormat(self))  # , height=1, width=7)
        self.button5.grid(row=1, column=1, ipady=10, pady=10, padx=5)
    ...
    def retrieve_home(self):
        self.button1.grid(row=0, column=1, ipady=10, pady=10, padx=5)
        self.button2.grid(row=0, column=2, ipady=10, pady=10, padx=5)
        self.button3.grid(row=0, column=3, ipady=10, pady=10, padx=5)
        self.button4.grid(row=0, column=4, ipady=10, pady=10, padx=5)
        self.button5.grid(row=1, column=2, ipady=10, pady=10, padx=5)
